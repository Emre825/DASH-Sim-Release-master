...
class DTPMmodule:
    ...
    def evaluate_idle_PEs(self):
        ...
        base_energy = base_power * common.sampling_rate * 1e-9 / (len(self.resource_matrix.list) - 1)
        for i, resource in enumerate(self.resource_matrix.list):
            ...
            if common.ClusterManager.cluster_list[current_PE.cluster_ID].type != 'MEM':
                ...
                if current_PE.process.count < current_PE.capacity:
                    ...
                    energy_sample = current_PE.current_leakage_core * common.sampling_rate * 1e-9
                    if common.ClusterManager.cluster_list[current_PE.cluster_ID].type != 'ACC':
                        energy_sample += base_energy
